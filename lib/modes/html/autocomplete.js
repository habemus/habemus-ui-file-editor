...
module.exports = function (fileEditor, options) {
  ...
  var snippetCompleterWithoutUselessDocs = {
    getCompletions: function (editor, session, pos, prefix, callback) {
      languageTools.snippetCompleter.getCompletions(editor, session, pos, prefix, function (err, completions) {


        // console.log('[snippetCompleterWithoutUselessDocs] completions', completions);
  ...
  // console.log(languageTools.snippetCompleter.getCompletions.toString());
  // console.log(languageTools.keyWordCompleter.getCompletions.toString());
  ...
  var htmlCompleterWithDocs = {
    getCompletions: function (editor, session, pos, prefix, callback) {
      languageTools.keyWordCompleter.getCompletions(editor, session, pos, prefix, function (err, completions) {


        console.log('[htmlCompleterWithDocs] completions', completions);
